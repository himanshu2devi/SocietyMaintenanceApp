...
export default function Home() {
  return (
    <main className="overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 pb-16 pt-12 sm:gap-12 sm:px-6 sm:pb-20 sm:pt-16 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:pb-28 lg:pt-20 xl:pt-24">
          <div className="min-w-0">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap">
              <Link
                to="/register"
                className="btn-primary !bg-orange-500 !px-6 !py-3.5 hover:!bg-orange-600"
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-28" aria-label="Society management software features">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:py-20">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {trustPoints.map(([title, body]) => (
              <article key={title} className="rounded-2xl border border-slate-100 bg-slate-50 p-6">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:items-center lg:py-28">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/register"
                className="btn-primary !bg-slate-950"
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 lg:py-28" aria-label="Get started with SocietyWale">
        ...
        <Link
          to="/register"
          className="btn-primary mt-8 !bg-orange-500 !px-6 !py-3.5 hover:!bg-orange-600"
